...
public class AddDetails extends AppCompatActivity {
    ...
    private EditText number, fullName, address;
//    private  ArrayAdapter<String> SecAdapter,BranchAdapter,SemAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nickName =findViewById(R.id.Name_details);
...
//        number.setAdapter(SecAdapter);
//        address.setAdapter(BranchAdapter);
//        fullName.setAdapter(SemAdapter);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                progressDialog.show();
                User user=new User(nickName.getText().toString(), fullName.getText().toString(),
        ...
        mDatabase.child("users").child(Objects.requireNonNull(auth.getUid())).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if(nickName.getText().toString().equals("")&&dataSnapshot.exists()){
