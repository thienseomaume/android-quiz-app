...
public class AttemptTest extends AppCompatActivity {
    ...
    void showPopUp(){
        ...
        builder.setMessage("Bạn có muốn nộp không?");
...
//                setAlertDialog(answerText);
    ...
    void dialogStart() {
        ...
        builderSingle.setNegativeButton("Xong", new DialogInterface.OnClickListener() {
            @Override
        ...
        builderSingle.setAdapter(arrayAdapter1, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                builderInner.setTitle("Câu trả lời mà bạn đã chọn");
...
//        }
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            holder.questionText.setText(data.get(currentPosition).getQuestion());
            holder.r1.setText(data.get(currentPosition).getOpt_A());
            holder.r2.setText(data.get(currentPosition).getOpt_B());
            holder.r3.setText(data.get(currentPosition).getOpt_C());
            holder.r4.setText(data.get(currentPosition).getOpt_D());
            holder.r5.setText("Xóa câu trả lời");
            ...
            holder.radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(RadioGroup radioGroup, int i) {
                    ...
                    final int selectedId = holder.radioGroup.getCheckedRadioButtonId();
                    if (i == R.id.radioButton) {
                        answers[newPosition] = data.get(newPosition).getOpt_A();
                    } else if (i == R.id.radioButton2) {
                        answers[newPosition] = data.get(newPosition).getOpt_B();
                    } else if (i == R.id.radioButton3) {
                        answers[newPosition] = data.get(newPosition).getOpt_C();
                    } else if (i == R.id.radioButton4) {
                        answers[newPosition] = data.get(newPosition).getOpt_D();
                    } else if (i == R.id.radioButton5) {
                        holder.radioGroup.clearCheck();
                        answers[newPosition] = null;
                    }
                    popGrid.notifyDataSetChanged();
                }
            });

            if (answers[currentPosition] == null) {
                holder.radioGroup.clearCheck();
            } else if (answers[currentPosition].equals(data.get(currentPosition).getOpt_A())) {
                holder.radioGroup.check(R.id.radioButton);
            } else if (answers[currentPosition].equals(data.get(currentPosition).getOpt_B())) {
                holder.radioGroup.check(R.id.radioButton2);
            } else if (answers[currentPosition].equals(data.get(currentPosition).getOpt_C())) {
                holder.radioGroup.check(R.id.radioButton3);
            } else if (answers[currentPosition].equals(data.get(currentPosition).getOpt_D())) {
                holder.radioGroup.check(R.id.radioButton4);
            }
        }
